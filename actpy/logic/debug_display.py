...
def draw_frame(screen, frame):
    """Draw a single frame."""
    frame_height = frame.shape[1] * DISPLAY_SCALE
    frame_width = frame.shape[0] * DISPLAY_SCALE
    ...
    frame_surface = pygame.transform.scale(frame_surface, (frame_height, frame_width))
